...
scanf("%d",&buscaid);
    ...
    if (buscaid == 1) {
        ...
        saldo_atual = c1.saldocliente; //// para salvar o saldo atual para o saldo cliente
    }
    else if (buscaid == 2) { ///ELSE IF SERVE PARA COMPILAR SE O PRIMEIRO NAO FOR VERDADEIRO
        printf("|==============================================================|\n");
        printf("===========Bem vindo: %s=================\n", c2.nome);
        strcpy(nome_selecionado, c2.nome); //// PARA COLAR O TEXTO
...
int d1, d2, d3, d4, d5, d6, d7, d8, d9, d10, d11;
	...
	char cpf_salvo[15]; /// variavel para salvar o CPF
	...
	if (d10 == fracao && d11 == fracao2){
		...
		sprintf(cpf_salvo, "%d%d%d.%d%d%d.%d%d%d-%d%d", ////DEIXAR O CPF SALVO
